...
public class LuceneNE2ESECatalog extends AbstractCatalog {
	...
	public LuceneNE2ESECatalog(Properties properties) {
		...
		if (maxListSize == null) {
			...
			LuceneNE2ESECatalog.maxListSize = Integer.parseInt(maxListSize);
		}
		...
		if (lucenePath == null) {
			...
			LuceneNE2ESECatalog.lucenePath = lucenePath;
		}
		...
		if (lucenePath == null) {
			...
			LuceneNE2ESECatalog.dateField = dateField;
		}
		...
		if (identifierField == null) {
			...
			LuceneNE2ESECatalog.identifierField = identifierField;
		}
		indexDir = new File(LuceneNE2ESECatalog.lucenePath);
